...
import edu.wm.cs.cs301.amazebyyunwoonoh.falstad.MazeFileWriter;
import edu.wm.cs.cs301.amazebyyunwoonoh.falstad.MazePanel;
...
public class Seg {
	...
	private void initColor(int distance, int cc) {
		...
		switch (part2) {
		case 0: setColor(rgbValue, 20, 20); break;
		case 1: setColor(20, rgbValue, 20); break;
		case 2: setColor(20, 20, rgbValue); break;
		case 3: setColor(rgbValue, rgbValue, 20); break;
		case 4: setColor(20, rgbValue, rgbValue); break;
		case 5: setColor(rgbValue, 20, rgbValue); break;
		default: setColor(20, 20, 20); break;
		}
	}
	...
	public void storeSeg(Document doc, Element mazeXML, int number, int i) {
		...
		MazeFileWriter.appendChild(doc, mazeXML, "colSeg_" + number+ "_" + i, panel.RGBGetter().getColor()) ;
	}
	...
	public boolean equals(Object other){
		...
		if ((x != o.x) || (dx != o.dx) ||(y != o.y) || (dy != o.dy)) 
			return false ; 
		if ((dist != o.dist) || (partition != o.partition) ||(seen != o.seen) || (panel.RGBGetter().getColor() != o.panel.RGBGetter().getColor()))
			return false ;
